    ...
    def _all_curated_routes(self) -> list[Hike]:
        ...
        routes = [
            ...
            Hike(
                ...
                canton="GR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-796",
                ...
                external_id="schweizmobil-fallback-796",
            ),
            Hike(
            ...
            Hike(
                ...
                canton="TI",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-636",
                ...
                external_id="schweizmobil-fallback-636",
            ),
            Hike(
            ...
            Hike(
                ...
                canton="LU",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-57",
                ...
                external_id="schweizmobil-fallback-57",
            ),
            Hike(
            ...
            Hike(
                ...
                canton="TI",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-2",
                ...
                external_id="schweizmobil-fallback-2",
            ),
            Hike(
                ...
                canton="VS",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-27",
                ...
                external_id="schweizmobil-fallback-27",
            ),
            Hike(
                ...
                canton="GR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-659",
                elevation_gain_m=400,
                ...
                external_id="schweizmobil-fallback-659",
            ),
            Hike(
                ...
                canton="VS",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-175",
                elevation_gain_m=500,
                ...
                external_id="schweizmobil-fallback-175",
            ),
            Hike(
            ...
            # Additional routes for expanded variety (40+ more routes)
            Hike(
                title="Lägern Gratwanderung",
                difficulty=self.normalize_difficulty("T2"),
                duration_minutes=210,
                distance_km=13.0,
                region="Zürich",
                canton="ZH",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-880",
                elevation_gain_m=400,
                elevation_loss_m=500,
                start_point="Baden",
                end_point="Uitikon",
                description="Beliebte Gratwanderung nördlich von Zürich mit herrlichen Aussichten ins Limmat- und Sihltal.",
                latitude_start=47.4500,
                longitude_start=8.3000,
                tags=["Gratwanderung", "Panorama", "Zürich"],
                external_id="schweizmobil-fallback-lagern",
            ),
            Hike(
                title="Thur-Romantik",
                difficulty=self.normalize_difficulty("T1"),
                ...
                canton="SG",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-820",
                elevation_gain_m=150,
                elevation_loss_m=150,
                start_point="Flawil",
                end_point="Wildpark Knie",
                description="Einfache Wanderung entlang der idyllischen Thur durch die Wälder der Appenzeller Alpen.",
                latitude_start=47.4000,
                longitude_start=9.0000,
                tags=["Fluss", "Familie", "Ostschweiz"],
                external_id="schweizmobil-fallback-thur",
            ),
            Hike(
                title="Gotthard Hospiz",
                difficulty=self.normalize_difficulty("T2"),
                duration_minutes=240,
                distance_km=11.0,
                region="Uri",
                canton="UR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-360",
                elevation_gain_m=650,
                elevation_loss_m=550,
                start_point="Göschenen",
                end_point="Hospenthal",
                description="Historische Wanderung über den Gotthard-Pass mit Besuch des historischen Hospizes.",
                latitude_start=46.6500,
                longitude_start=8.6500,
                tags=["Gotthard", "Historisch", "Alpen"],
                external_id="schweizmobil-fallback-gotthard",
            ),
            Hike(
                title="Linth-Limmern",
                difficulty=self.normalize_difficulty("T2"),
                ...
                canton="GL",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-450",
                elevation_gain_m=800,
                elevation_loss_m=800,
                start_point="Linthal",
                end_point="Linthal",
                description="Spektakuläre Wanderung im Glarnerland mit Gletscherblick und alpinen Blumenwiesen.",
                latitude_start=46.7333,
                longitude_start=8.8667,
                tags=["Glarnisch", "Gletscher", "Alpen"],
                external_id="schweizmobil-fallback-linth",
            ),
            Hike(
                title="Rheinufer Baden-Säckingen",
                difficulty=self.normalize_difficulty("T1"),
                duration_minutes=120,
                distance_km=8.0,
                region="Nördliche Schweiz",
                canton="AG",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-670",
                elevation_gain_m=80,
                elevation_loss_m=80,
                start_point="Bad Säckingen",
                end_point="Rheinfelden",
                description="Einfache, malerische Wanderung entlang des Rheins mit Blick auf historische Brücken.",
                latitude_start=47.5500,
                longitude_start=7.9500,
                tags=["Rhein", "Familie", "Historisch"],
                external_id="schweizmobil-fallback-rhein",
            ),
            Hike(
                title="Wetterhorn Panorama",
                difficulty=self.normalize_difficulty("T3"),
                duration_minutes=300,
                distance_km=16.0,
                region="Berner Oberland",
                canton="BE",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-580",
                elevation_gain_m=1100,
                elevation_loss_m=1100,
                start_point="Grindelwald",
                end_point="Grindelwald",
                description="Anspruchsvolle Bergtour mit spektakulären Ausblicken auf Wetterhorn und Eiger.",
                latitude_start=46.6167,
                longitude_start=8.3333,
                tags=["Eiger", "Wetterhorn", "Alpen"],
                external_id="schweizmobil-fallback-wetterhorn",
            ),
            Hike(
                title="Jungfrau Besteigung",
                difficulty=self.normalize_difficulty("T4"),
                ...
                canton="BE",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-585",
                elevation_gain_m=1800,
                elevation_loss_m=1800,
                start_point="Lauterbrunnen",
                end_point="Lauterbrunnen",
                description="Anspruchsvolle Bergwanderung zur Jungfrau mit atemberaubenden Ausblicken.",
                latitude_start=46.5833,
                longitude_start=8.1667,
                tags=["Jungfrau", "Alpen", "Anspruchsvoll"],
                external_id="schweizmobil-fallback-jungfrau",
            ),
            Hike(
                title="Zermatt Gornergrat",
                difficulty=self.normalize_difficulty("T3"),
                duration_minutes=240,
                distance_km=12.0,
                region="Wallis",
                canton="VS",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-620",
                elevation_gain_m=600,
                elevation_loss_m=600,
                start_point="Zermatt",
                end_point="Zermatt",
                description="Wanderung zum spektakulären Görnergletscher mit direktem Matterhorn-Blick.",
                latitude_start=46.0167,
                longitude_start=7.7500,
                tags=["Matterhorn", "Gletscher", "Wallis"],
                external_id="schweizmobil-fallback-gorner",
            ),
            Hike(
                title="Rhone-Gletscher",
                difficulty=self.normalize_difficulty("T2"),
                duration_minutes=180,
                distance_km=10.0,
                region="Wallis",
                canton="VS",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-610",
                elevation_gain_m=400,
                elevation_loss_m=400,
                start_point="Gletsch",
                end_point="Gletsch",
                description="Wanderung zur Quelle der Rhone am imposanten Rhone-Gletscher.",
                latitude_start=46.5667,
                longitude_start=8.3333,
                tags=["Gletscher", "Rhone", "Gotthard"],
                external_id="schweizmobil-fallback-rhone",
            ),
            Hike(
                title="Luganer See Uferweg",
                difficulty=self.normalize_difficulty("T1"),
                duration_minutes=150,
                distance_km=9.0,
                region="Tessin",
                canton="TI",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-705",
                elevation_gain_m=200,
                elevation_loss_m=200,
                start_point="Paradiso",
                end_point="Morcote",
                description="Malerische Uferwanderung um den Luganer See mit südländischer Atmosphäre.",
                latitude_start=46.0167,
                longitude_start=8.9667,
                tags=["Luganer See", "Familie", "Tessin"],
                external_id="schweizmobil-fallback-lugano",
            ),
            Hike(
                title="Gotthard Passhöhe",
                difficulty=self.normalize_difficulty("T1"),
                duration_minutes=90,
                distance_km=5.0,
                region="Zentralschweiz",
                canton="UR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-365",
                elevation_gain_m=200,
                elevation_loss_m=200,
                start_point="Göschenen",
                end_point="Andermatt",
                description="Kurze, einfache Wanderung über den historischen Gotthard-Pass.",
                latitude_start=46.5500,
                longitude_start=8.6300,
                tags=["Gotthard", "Familie", "Historisch"],
                external_id="schweizmobil-fallback-gotthard2",
            ),
            Hike(
                title="Piz Segnas Besteigung",
                difficulty=self.normalize_difficulty("T3"),
                duration_minutes=300,
                distance_km=14.0,
                region="Graubünden",
                canton="GR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-480",
                elevation_gain_m=1200,
                elevation_loss_m=1200,
                start_point="Elm",
                end_point="Elm",
                description="Bergwanderung zu spektakulären Gipfel-Panoramen im Säntis-Massiv.",
                latitude_start=46.8167,
                longitude_start=9.1333,
                tags=["Säntis", "Gipfel", "Graubünden"],
                external_id="schweizmobil-fallback-segnas",
            ),
            Hike(
                title="Schanfigg Rundweg",
                difficulty=self.normalize_difficulty("T2"),
                duration_minutes=240,
                distance_km=13.0,
                region="Graubünden",
                canton="GR",
                source="schweizmobil",
                source_url="https://www.schweizmobil.ch/de/wanderland/route-500",
                elevation_gain_m=600,
                elevation_loss_m=600,
                start_point="Arosa",
                end_point="Arosa",
                description="Beliebte Rundwanderung im herbstlich gefärbten Schanfigg-Tal.",
                latitude_start=46.7833,
                longitude_start=9.8500,
                tags=["Arosa", "Schanfigg", "Graubünden"],
                external_id="schweizmobil-fallback-schanfigg",
            ),
        ]
